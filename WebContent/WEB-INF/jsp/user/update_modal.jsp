                    ...
                    <form:form action="update_modal.htm" modelAttribute="news"  id="createModal">
                       ...
                       <div class="form-group clearfix">
                        ...
                        <div class="col-sm-10 controls">
                          <input id="form-header" type="text" class="input-border-btm" name="header" value="${news.header}">
                        </div>
                      </div>
                      <div class="form-group clearfix">
                        <label class="col-sm-2 control-label">Content</label>
                        <div class="col-sm-10 controls">
                          <input id="form-content" type="text" class="input-border-btm" name="content" value="${news.content}">
                        </div>
                      </div>
                      <div class="form-group  clearfix">
